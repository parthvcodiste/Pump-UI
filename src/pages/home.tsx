...
const HomePage: React.FC = () => {
  ...
  return (
    <Layout>
      <SEO
        title="HyperLiquid Fun - Create and Trade Tokens with Bonding Curves"
        description="Launch and trade tokens effortlessly using innovative bonding curve technology. Experience fair, dynamic, and continuous liquidity on HyperLiquid Fun."
      ...
      <div className="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24">
            <div className="text-center">
              ...
              >
                <Link
                  href="/explore"
                  className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 border border-transparent text-sm sm:text-base font-medium rounded-full text-white bg-blue-500 hover:bg-blue-600 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg"
                >
                  Enter App
                  <ArrowRightIcon
        ...
        <section className="py-12 sm:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center text-blue-400 mb-8 sm:mb-12">
              Why Choose HyperLiquid Fun?
            </h2>
        ...
        <section className="py-12 sm:py-16">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg sm:text-xl text-gray-400 mb-6 sm:mb-8">
              Join HyperLiquid Fun today and experience the future of
              decentralized finance.
            </p>
            <Link
              href="/explore"
              className="inline-flex items-center px-6 sm:px-8 py-2 sm:py-3 border border-transparent text-sm sm:text-base font-medium rounded-full text-gray-900 bg-blue-400 hover:bg-blue-300 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg"
            >
