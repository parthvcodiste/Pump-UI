    ...
    <Layout>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form
          ...
          className="space-y-6 bg-[var(--card)] p-4 sm:p-6 rounded-lg"
        >
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label
                htmlFor="tokenName"
                className="block text-[10px] sm:text-xs font-medium text-gray-400 mb-1"
              >
                Token Name
              </label>
              <input
          ...
          <div>
            <label
              htmlFor="tokenImage"
              className="block text-[10px] sm:text-xs font-medium text-gray-400 mb-2"
            >
              Token Image
            </label>
            <div
