            ...
            >
              ...
              >
                <div className="p-4 sm:p-5 bg-[var(--card2)]">
                  <p className="text-xs sm:text-sm text-gray-400 whitespace-pre-line leading-relaxed">
                    {faq.answer}
                  </p>
                </div>
              </div>
