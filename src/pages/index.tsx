...
const Home: React.FC = () => {
            ...
            if (allTrendingTokens.length === 0) {
              ...
              if (sort === "marketcap") {
                fetchedTokens = {
                  ...
                  totalPages: Math.ceil(
                    trendingTokens.length / TOKENS_PER_PAGE
                  ),
                  fullList: true,
                };
              } else {
                ...
                const paginatedTokens = trendingTokens.slice(
                  startIndex,
                  endIndex
                );
              ...
              if (sort === "marketcap") {
                fetchedTokens = {
                  ...
                  currentPage: currentPage,
                  totalPages: Math.ceil(
                    allTrendingTokens.length / TOKENS_PER_PAGE
                  ),
                  fullList: true,
                };
              } else {
                const startIndex = (currentPage - 1) * TOKENS_PER_PAGE;
                const endIndex = startIndex + TOKENS_PER_PAGE;
                const paginatedTokens = allTrendingTokens.slice(
                  startIndex,
                  endIndex
                );
  ...
  return (
    <Layout>
      <SEO
        title="Create and Trade Memecoins Easily on HyperLiquid Fun."
